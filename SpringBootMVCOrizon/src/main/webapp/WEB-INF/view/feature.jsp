...
<title>Car-Scanner-Features</title>
</head>
<body style="background-color: lavender">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<div>
					<h1 class="display-4 text-center mt-5">Cars List</h1>
					<p class="text-center">**Table contains List of Cars and also
						its specifications</p>

					<button type="button" class="btn btn-primary" onclick="window.location.href='addCar';return false;">
						Add Car
					</button>


					<button type="button" class="btn btn-primary" onclick="window.location.href='searchCar';return false;">Search Car</button>
						...
						<tbody>
							...
							<c:param name="deleteId" value="${car.id}"></c:param>
								...
								<tr>
									...
									<td><a href="${updateLink }"> <button class="btn btn-primary">Update</button></a></td>
